    ...
    <footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div
            ...
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                <a className="flex items-center text-center justify-center font-medium text-gray-900 title-font md:justify-start">
                     <p className="text-center">  Admission Portal</p>
                </a>
        ...
        <div className="bg-gray-300">
            <div className="container px-5 py-4 mx-auto">
                <p className="text-sm text-gray-700 capitalize xl:text-center">Admission Portal © 2023 All rights reserved </p>
            </div>
        </div>
    </footer>
